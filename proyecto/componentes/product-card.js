class productCard extends HTMLElement { 
  ...
  render () { 
    this.shadowRoot.appendChild(this.getTemplate().content.cloneNode(true)); // ! Esto cuando esta en "TRUE" clona todo lo que esta dentro del getTemplate y asi es como le agregamos los nodos a "product-card".
  }
  connectedCallback () { // ! connectedCallback hace que lo del render aparezca en el DOM
    this.render();
  }
}
